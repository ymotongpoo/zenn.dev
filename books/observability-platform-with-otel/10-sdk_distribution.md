...
![素のSDKと社内ディストリビューションの対比](/images/20260926-raw-sdk-vs-distribution.png)

*図1　矢印は、初期化の判断がどこで決まるかを表します。素のSDKでは判断がサービスごとに分かれ、欠けた属性や設定の差がサービスを横断した検索に現れます。社内ディストリビューションは同じ判断を1箇所に集め、各サービスは1回の呼び出しで組織のデフォルト値を得ます。*
