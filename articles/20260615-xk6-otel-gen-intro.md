...
興味を持っていただいた方向けに少しだけOSSとしての性格を共有します。Apache License 2.0で公開はしているものの、仕事でもAI slopに疲れ気味なので、当面pull requestは受け付けません。そのかわりユースケースの提案や明らかなバグ報告などは歓迎します。片手間で開発するツールで全部AIに投げて実装するため、詳細なレポートが重要となるためテンプレートを固定しています。
